...
[[ -z "${PROMPT_COLOR_PWD}" ]] && PROMPT_COLOR_PWD=228
[[ -z "${PROMPT_COLOR_GIT}" ]] && PROMPT_COLOR_GIT=221 # branch name
[[ -z "${PROMPT_COLOR_GIT_DIRTY}" ]] && PROMPT_COLOR_GIT_DIRTY=250
[[ -z "${PROMPT_COLOR_GIT_ARROW}" ]] && PROMPT_COLOR_GIT_ARROW=250
[[ -z "${PROMPT_COLOR_EXECTIME}" ]] && PROMPT_COLOR_EXECTIME=214
...
[[ -z "${PROMPT_COLOR_VIMCMD}" ]] && PROMPT_COLOR_VIMCMD=244
[[ -z "${PROMPT_COLOR_VIMVIS}" ]] && PROMPT_COLOR_VIMVIS=244
[[ -z "${PROMPT_COLOR_VIMREP}" ]] && PROMPT_COLOR_VIMREP=244
[[ -z "${PROMPT_COLOR_VIMINS}" ]] && PROMPT_COLOR_VIMINS=244
